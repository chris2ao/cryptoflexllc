    ...
    >
      ...
      >
        ...
        <text
          ...
          y="178"
          textAnchor="middle"
          className="fill-success/90 text-[9px]"
        >
        ...
        <text
          ...
          y="323"
          textAnchor="middle"
          className="fill-destructive/90 text-[9px]"
        >
        ...
        <text
          ...
          y="393"
          textAnchor="middle"
          className="fill-warning text-[11px] font-semibold"
        >
        ...
        <text
          ...
          y="468"
          textAnchor="middle"
          className="fill-warning/90 text-[9px]"
        >
        ...
        <text
          ...
          y="180"
          textAnchor="middle"
          className="fill-success/80 text-[9px]"
        >
        ...
        <text
          ...
          y="325"
          textAnchor="middle"
          className="fill-destructive/80 text-[9px]"
        >
        ...
        <text
          ...
          y="452"
          textAnchor="middle"
          className="fill-warning/80 text-[9px]"
        >
