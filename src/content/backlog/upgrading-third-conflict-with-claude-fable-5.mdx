...
description: >-
  ...
  tests anyway, thanks to one session with Claude Fable 5 and seven agents running
  in parallel. Also included: the difficulty system we caught making easy mode
  stronger than hard.
tags:
  - Claude Code
  - Claude Fable 5
