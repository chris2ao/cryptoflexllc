...
![Overview of Claude Code features and how they relate to each other](/images/blog/claude-code-features/feature-overview.png)
...
![The configuration stack: CLAUDE.md, Rules, Hooks, MCP, Agents](/images/blog/claude-code-features/config-layers.png)
...
![Permission levels from read-only to full access](/images/blog/claude-code-features/permission-levels.png)
...
![Serial execution versus parallel subagent execution](/images/blog/claude-code-features/serial-vs-parallel.png)
