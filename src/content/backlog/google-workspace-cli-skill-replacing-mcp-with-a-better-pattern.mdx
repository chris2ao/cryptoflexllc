---
title: 'Google Workspace in Claude Code: Why I Replaced Three MCP Servers with a CLI Skill'
date: '2026-03-11T10:00:00'
description: >-
  How I replaced three separate Google Workspace MCP integrations with a single gws CLI skill,
  why CLI beats MCP for large API surfaces, and the four-tier safety system that keeps
  destructive operations from running without confirmation.
tags:
  - Claude Code
  - Google Workspace
  - MCP
