...
description: "I set up the Claude Code iMessage plugin as a proof of concept, debugged two real bugs, and discovered a fundamental security flaw that made me tear the whole thing down. Here's the full story."
tags: ["Claude Code", "Channels", "iMessage", "Security", "Workflow", "Plugins"]
