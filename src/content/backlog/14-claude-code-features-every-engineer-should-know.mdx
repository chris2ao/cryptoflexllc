...
![The configuration stack: from CLAUDE.md at the foundation up through Rules, Skills, MCP, and Agents at the top](/images/blog/claude-code-features/config-layers.png)
...
![Permission levels from Read Only (most restrictive) through Approve Each Action, Allow List, Accept Edits, to Full Auto (most permissive)](/images/blog/claude-code-features/permission-levels.png)
...
![Serial execution (12 minutes, one task at a time) versus parallel subagent execution (5 minutes, multiple agents working simultaneously)](/images/blog/claude-code-features/serial-vs-parallel.png)
