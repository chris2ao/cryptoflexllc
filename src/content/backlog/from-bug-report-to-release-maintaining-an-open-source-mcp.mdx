...
That was issue #5 against [unifi-mcp](https://github.com/chris2ao/unifi-mcp), the unified UniFi Network and Protect MCP server I [built over three days](/blog/building-a-custom-unifi-mcp-103-tools-across-three-days) and have been [dogfooding](/blog/dogfooding-the-unifi-mcp-homenet-document-and-the-bug-it-found) ever since. Two real port-forward bugs, a couple of edits to fix, and then the longer tail: turning a merged fix into a release a stranger can actually install.
