...
<img
  src="/blog/homenet-dashboard-phase-3/infographic.png"
  alt="Visual summary of Home Network Mission Control Phase 3: a re-runnable plan doc as the contract between OpenAI Codex and Claude Code, two PRs merged same-day, eleven deferred items closed, three integration layers (software, tool, process)."
  loading="lazy"
/>
