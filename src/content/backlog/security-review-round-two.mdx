...
Everything the team rated Critical or High is fixed and deployed. 812 tests pass. The production build is green on Next.js 16.3.0. The known-vulnerability count went from 17 down to 12. All 91 posts pass the new frontmatter fence check, including the ones written before any of this review started.
