...
![Sweeping the deferred queue closes the loop: 20 starting items at the top of Phase 3, then Wave 1 backend hardening (3 items) and Wave 2 frontend polish (8 items) closed in the same session, leaving 9 items remaining (the explicit v2 / mode-B-gated work).](/blog/homenet-dashboard-phase-3/slides/slide-10.png)
...
![Four immutable heuristics for AI engineering distilled from Phase 3: FORMAT_IS_PRE_CI, SIBLINGS_ARE_TRUTH, CLICK_THROUGHS_ARE_INTEGRATION, SWEEP_QUEUES_IN_SESSION.](/blog/homenet-dashboard-phase-3/slides/slide-13.png)
