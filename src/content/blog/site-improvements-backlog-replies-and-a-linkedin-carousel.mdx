---
title: >-
  Site Improvements: A Backlog System, Comment Threading, and an Interactive
  Carousel
description: >-
  Three features that turned a static blog into something closer to a content
  platform: draft staging via GitHub API, threaded comment replies, and a
  swipeable LinkedIn carousel built in React.
date: '2026-02-26'
