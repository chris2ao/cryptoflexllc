...
seriesOrder: 6
coverImage: /blog/home-network-mission-control-dashboard-dns-search-panel/infographic.jpg
coverImageAlt: >-
  Engineering a Searchable SIEM Dashboard, branded NotebookLM infographic
  summarizing the DNS Search Panel build session
published: false
---
...
If you'd rather read this as slides, the deck version is here: [DNS Search Panel slide deck (PDF)](https://u6qcxb8rfplaydjl.public.blob.vercel-storage.com/blog/home-network-mission-control-dashboard-dns-search-panel/slides.pdf). Same arc as the post, fewer words per page.
