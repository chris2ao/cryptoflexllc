...
seriesOrder: 6
coverImage: /blog/upgrading-third-conflict-with-claude-fable-5/infographic.jpg
coverImageAlt: >-
...
The infographic at the top and the slides throughout came from feeding the finished draft to NotebookLM. If you want the session in shareable form, the [full 10-slide deck is available as a PDF](https://u6qcxb8rfplaydjl.public.blob.vercel-storage.com/blog/upgrading-third-conflict-with-claude-fable-5/third-conflict-fable-5-slides.pdf).
...
If any of this sounds fun, [Third Conflict is free to play in your browser](https://third-conflict.vercel.app). No install, no account. Watch a turn play out, flip the new toggles on, and see if you can beat the AI that practices at 300 games per second. And yes, easy mode actually is easier now.
