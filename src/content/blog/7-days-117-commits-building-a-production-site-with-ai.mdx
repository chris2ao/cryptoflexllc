...
<Info>
**Want the visual version?** Check out the [10-slide interactive carousel](/resources/week-one-carousel) for a quick visual recap of the entire build: stats, timeline, security findings, architecture, and key takeaways.
</Info>
