...
![Two Bugs Past the Goal Line: Phase 1.1 title slide. 5 surfaces, 2 security signals, 694 pytest, 24/24 Playwright, Wave 0 found 3 UDM v9+ wire-shape surprises.](/blog/home-network-mission-control-dashboard-phase-1-1/slides/slide-01.png)
...
![UDM v9+ deployment analysis infographic: Wave 0 wire-shape surprises, the 5-wave deployment funnel catching the CRITICAL ship-blocker, and the two post-merge silent-zero bugs caught by live in-session verification.](/blog/home-network-mission-control-dashboard-phase-1-1/udm-v9-gotchas-infographic.png)
