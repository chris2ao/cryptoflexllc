...
series: Custom SIEM
seriesOrder: 1
coverImage: /blog/building-a-custom-siem-part-1-why-and-architecture/infographic.jpg
---
...
![Custom Homelab SIEM Architecture: UDP syslog from UDM Pro, Pi-hole, U7 Pro APs, and USW-Flex switches into Vector running on a Mac mini M4 docker-compose stack, parsed and written to ClickHouse on a 300 GB external SSD with 180-day TTL retention. SQLite retained for reference and ack data. macOS osascript push and Gmail digest for findings.](/blog/building-a-custom-siem-part-1-why-and-architecture/infographic.jpg)
