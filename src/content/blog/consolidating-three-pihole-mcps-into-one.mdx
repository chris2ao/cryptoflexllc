...
seriesOrder: 6
coverImage: /blog/pihole-mcp/infographic.jpg
...
![Visual summary of the pihole-mcp build: 5 MCPs surveyed, 3 consolidated, 28 tools across 6 modules, public GitHub release with CI and branch protection](/blog/pihole-mcp/infographic.jpg)
...
![Validating assumptions with pre-build AI research: two parallel investigations confirming no DPI degradation and mapping the 5 existing Pi-hole MCP servers](/blog/pihole-mcp/slides/slide-03.webp)
...
![System architecture: 28 tools across 6 core modules (stats, queries, blocking, domains, local_dns, maintenance) wired to a single FastMCP server.py](/blog/pihole-mcp/slides/slide-06.webp)
...
![Resilient session auth pattern: Init, Active State, 60-second pre-expiry buffer, bounded 401 retry, best-effort DELETE on shutdown](/blog/pihole-mcp/slides/slide-07.webp)
...
![Open-source polish standard: MIT license, Python 3.12+ CI matrix, passing tests, MCP compatibility, Pi-hole v6 badges, plus CONTRIBUTING, CODE_OF_CONDUCT, issue templates, and branch protection](/blog/pihole-mcp/slides/slide-10.webp)
