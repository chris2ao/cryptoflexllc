...
seriesOrder: 8
coverImage: /blog/home-network-mission-control-dashboard-client-traffic/infographic.jpg
coverImageAlt: >-
...
![The cyber-themed Overview tab showing N//C MISSION CONTROL with 61 clients online, 189,503 DNS queries, 50,410 blocked, active noisy endpoint list, WAN probe, and threat vector heat strip. This is the dashboard's primary state as of the session that preceded the client traffic build.](/blog/home-network-mission-control-dashboard-client-traffic/overview.webp)
