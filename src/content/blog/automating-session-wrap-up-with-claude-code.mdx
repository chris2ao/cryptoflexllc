...
<Stop title="Why the Conflict Check">
...
<Info title="Full Session Context">
...
<Tip title="Give Decision-Making Criteria">
...
<Info title="Cross-Session Context">
...
<Security title="The Confirmation Step">
...
<Warning title="Why This Cleanup Exists">
...
<Warning title="The HEREDOC Permission Bug">
...
<Tip title="Persona as a Pattern">
...
<Warning title="Windows PATH Note">
...
<Security title="The Secrets Rule">
...
<Stop title="The Force Push Rule">
...
<Warning title="The PowerShell Rule">
I wasted 20 minutes debugging why `$env:USERPROFILE` was empty in a PowerShell command - turns out Git Bash was eating the `$` before PowerShell ever saw it. The workaround: write a temp `.ps1` file and execute it, instead of using inline PowerShell commands from bash. (This is now [learned skill #8](/blog/configuring-claude-code).)
</Warning>

<Info title="Read Before Editing">
...
<Warning title="The Freeze That Added Step 7">
...
<Info title="2. Include the Format">
...
<Security title="3. Add Safety Rails">
...
<Tip title="4. Give Decision-Making Criteria">
...
<Warning title="5. Encode Your Gotchas">
