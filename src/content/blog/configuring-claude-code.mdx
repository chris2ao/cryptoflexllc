...
**The lesson:** Every MCP server adds startup overhead and context cost. Only keep servers that provide capabilities Claude Code genuinely lacks. But re-evaluate periodically — your needs change as your workflow matures.
