...
|--------|-----------------|
| **sequential-thinking** | Claude Code's built-in extended thinking (31,999 tokens) already does this |
| **filesystem** | Built-in Read/Write/Edit/Glob/Grep tools already handle file operations |
| **github** | The `gh` CLI via Bash covers most GitHub operations |
...
*This post is part of a series about AI-assisted development. Previous: [Getting Started with Claude Code](/blog/getting-started-with-claude-code). Next: [How I Built This Site](/blog/how-i-built-this-site).*
