...
import { ConfigStackDiagram, PermissionLevelsDiagram, SerialVsParallelDiagram } from '@/components/mdx';
...
![14 Claude Code Features Every Engineer Should Know: a grid showing each feature with its category, icon, and brief description](/images/blog/claude-code-features/infographic.webp)
