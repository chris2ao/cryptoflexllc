...
seriesOrder: 19
coverImage: >-
  /blog/the-squash-vs-granular-trap-reconciling-an-unmergeable-branch/infographic.jpg
coverImageAlt: >-
...
If you'd rather read this as slides, the deck version is here: [Squash-vs-Granular Reconcile Playbook slide deck (PDF)](https://u6qcxb8rfplaydjl.public.blob.vercel-storage.com/blog/the-squash-vs-granular-trap-reconciling-an-unmergeable-branch/slides.pdf). Same arc as the post, fewer words per page.
