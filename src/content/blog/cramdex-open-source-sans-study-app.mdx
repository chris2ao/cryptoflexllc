...
coverImage: /blog/cramdex-open-source-sans-study-app/infographic.jpg
coverImageAlt: >-
...
![Infographic covering the GIAC open-book exam problem, the cramdex study loop of reading, searching, quizzing, and capturing citations, and the printed index it produces on exam day, illustrated with fictional MOON-101 course terms](/images/blog/cramdex/cramdex-index-infographic.webp)
...
![Slide titled The Study Engine: Four Core Tools, summarizing the book reader, SQLite FTS5 full-text search, quiz decks with mastery tracking, and grounded Ask with pluggable LLM providers](/images/blog/cramdex/cramdex-slide-core-tools.webp)

![Slide titled The Exam Index Builder, showing the four-step pipeline from capture anywhere through explicit review and the alphabetical manage view to export and print](/images/blog/cramdex/cramdex-slide-index-builder.webp)

![Slide titled Launch in Two Minutes, showing the three commands to clone cramdex, run the demo setup, and serve the app, with annotations for each step](/images/blog/cramdex/cramdex-slide-setup.webp)

![Slide titled The Zero-Content Constraint, diagramming the repo boundary between the public engine codebase with its fictional demo course and the user's local course packs](/images/blog/cramdex/cramdex-slide-zero-content.webp)
