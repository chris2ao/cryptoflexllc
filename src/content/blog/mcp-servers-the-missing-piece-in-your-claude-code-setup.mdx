...
date: '2026-03-10'
description: >-
  A practical walkthrough of the 5 Node.js MCP servers I run with Claude Code:
  sequential-thinking, memory, context7, github, and project-tools. What they
  do, how to configure them on Windows, and what I learned testing each one.
tags:
  - Claude Code
  - MCP
  - Workflow
