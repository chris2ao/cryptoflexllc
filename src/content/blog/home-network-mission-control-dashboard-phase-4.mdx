...
seriesOrder: 4
coverImage: /blog/home-network-mission-control-dashboard-phase-4/infographic.jpg
coverImageAlt: >-
...
![Home Network Mission Control V2 overview: 161 anomalies from 45,000 daily DNS queries, Threat Intel tab marquee, 7 PRs on one Sunday, 603 backend tests at merge.](/blog/home-network-mission-control-dashboard-phase-4/slides/slide-01.webp)
...
![The AnomalyFeed card on the live Threat Intel tab: cursor-paginated list of anomalies, score badges color-coded by severity, rule pills rendered specific-before-broad with feed_hit always first, score collapse and tune-mode tagged with a tilde glyph.](/images/blog/homenet-mission-control-v2-anomaly-feed.png)
...
![The six heuristics (H1-H6) with weights, tune-mode for H3 and H5 at weight zero, and the H1+H6 score collapse rule.](/blog/home-network-mission-control-dashboard-phase-4/slides/slide-04.webp)
...
![The Overview tab of the V2 dashboard for context. The new Threat Intel tab sits next to Overview, Clients, Security, and DNS in the cyber-themed nav, fed by the same poll-and-cache architecture as the rest of the dashboard.](/images/blog/homenet-mission-control-v2-overview.png)
...
![Persona team dispatch: 8 blocking findings caught pre-merge across Threat Intel, Security, Network, and UX reviewers. All fixed before the marquee PR landed.](/blog/home-network-mission-control-dashboard-phase-4/slides/slide-08.webp)
...
![Bug 3: Pi-hole v6 silent zero on H4. Fixture frozen at v5 wire format; production ran v6. 34,600 rows with empty reply_type; H4 always scored zero.](/blog/home-network-mission-control-dashboard-phase-4/slides/slide-11.webp)
...
![Why all five bugs share one shape: the test was correct, the surrounding system was the bug. Five different failure modes, same root cause.](/blog/home-network-mission-control-dashboard-phase-4/slides/slide-12.webp)
