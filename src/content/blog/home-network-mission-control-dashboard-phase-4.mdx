...
![Home Network Mission Control V2 overview: 161 anomalies from 45,000 daily DNS queries, Threat Intel tab marquee, 7 PRs on one Sunday, 603 backend tests at merge.](/blog/home-network-mission-control-dashboard-phase-4/slides/slide-01.png)
...
![The six heuristics (H1-H6) with weights, tune-mode for H3 and H5 at weight zero, and the H1+H6 score collapse rule.](/blog/home-network-mission-control-dashboard-phase-4/slides/slide-04.png)
...
![Persona team dispatch: 8 blocking findings caught pre-merge across Threat Intel, Security, Network, and UX reviewers. All fixed before the marquee PR landed.](/blog/home-network-mission-control-dashboard-phase-4/slides/slide-08.png)
...
![Bug 3: Pi-hole v6 silent zero on H4. Fixture frozen at v5 wire format; production ran v6. 34,600 rows with empty reply_type; H4 always scored zero.](/blog/home-network-mission-control-dashboard-phase-4/slides/slide-11.png)
...
![Why all five bugs share one shape: the test was correct, the surrounding system was the bug. Five different failure modes, same root cause.](/blog/home-network-mission-control-dashboard-phase-4/slides/slide-12.png)
