...
*Built with Claude Code (Opus 4.6). The full source code is at [github.com/chris2ao/cryptoflexllc](https://github.com/chris2ao/cryptoflexllc). The infrastructure documentation, including the complete WAF setup guide, is in a separate private repo. This post is part of a series about AI-assisted development and security. Previous: [Making Claude Code Talk: Terminal Bells and the Stop Hook](/blog/making-claude-code-talk-terminal-bells-and-the-stop-hook). Next: [Building a Blog Newsletter from Scratch](/blog/adding-blog-subscriptions-and-weekly-digest).*
