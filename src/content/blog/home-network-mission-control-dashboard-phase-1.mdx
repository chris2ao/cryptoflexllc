...
![Side-by-side comparison of live-fetch versus poll-and-cache, plus a heartbeat sentinel time-series chart distinguishing accurate gaps (the host was asleep) from misleading zeros (Pi-hole blocked nothing — never true).](/blog/homenet-dashboard-phase-1/slides/slide-06.png)
