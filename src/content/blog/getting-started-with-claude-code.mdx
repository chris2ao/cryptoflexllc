...
*This post is part of a series about AI-assisted development. Previous: [Building This Site with Claude Code](/blog/building-with-claude-code). Next up: [Configuring Claude Code](/blog/configuring-claude-code) - rules, hooks, MCP servers, and the plugin ecosystem.*
